...
Defines the developer tooling that keeps the JellyTV project reproducible and easy to bootstrap: deterministic Xcode project generation, a one-command setup script, a shared Swift package linked by both apps, code-generated branding assets, and repo hygiene plus MCP tooling.
