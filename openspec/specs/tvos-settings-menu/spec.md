...
Defines the tvOS Settings screen: a full-screen two-pane peer of Home (a category list plus a per-category detail pane) reached via the navigation rail's Settings icon, its category detail content, and the live-updating theme accent selection.
