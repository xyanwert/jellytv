# tvos-show-view Specification

## Purpose

Defines the tvOS full-screen Show view for a collection (a series with seasons and episodes): its layout, season selection, episode strip, remote navigation, and launch from the Home Recommended row.
