# tvos-app-shell Specification

## Purpose

Defines the tvOS app shell for JellyTV: a buildable, launchable, and App Store-submittable Apple TV app carrying complete identity metadata, brand assets, a privacy manifest, and distribution signing. This is the foundation the product's tvOS experience builds on.
