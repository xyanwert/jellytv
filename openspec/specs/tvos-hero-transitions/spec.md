# tvos-hero-transitions Specification

## Purpose

Defines the visual transition between hero backdrops as the carousel advances: the Metal-based crumble effect, the fade fallback, the configurable/persisted transition style, and the clean resting state between transitions.
